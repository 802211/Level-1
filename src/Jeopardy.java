...
frame.setVisible(true);
			...
			JPanel pane = createHeader("books");
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(buttonPressed.equals(firstButton)){
				askQuestion("Who is the author of the series (book) Harry Potter", "J.K. Rowling", 100);
			firstButton.setText(null);
			}
			else if(buttonPressed.equals(secondButton)){
				askQuestion("Who is the author of the Mortality Doctrine series?", "James Dashner",  200);
